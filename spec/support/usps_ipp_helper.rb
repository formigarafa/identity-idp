module UspsIppHelper
  def stub_request_token
    stub_request(:post, %r{/oauth/authenticate}).to_return(
      status: 200, body: UspsInPersonProofing::Mock::Fixtures.request_token_response,
    )
  end

  def stub_request_facilities
    stub_request(:post, %r{/ivs-ippaas-api/IPPRest/resources/rest/getIppFacilityList}).to_return(
      status: 200, body: UspsInPersonProofing::Mock::Fixtures.request_facilities_response,
    )
  end

  def stub_request_enroll
    stub_request(:post, %r{/ivs-ippaas-api/IPPRest/resources/rest/optInIPPApplicant}).to_return(
      status: 200, body: UspsInPersonProofing::Mock::Fixtures.request_enroll_response,
    )
  end

  def stub_request_enroll_bad_request_response
    stub_request(:post, %r{/ivs-ippaas-api/IPPRest/resources/rest/optInIPPApplicant}).to_return(
      status: 400, body: UspsInPersonProofing::Mock::Fixtures.request_enroll_bad_request_response,
    )
  end
  ...
  def stub_request_enroll_invalid_response
    stub_request(:post, %r{/ivs-ippaas-api/IPPRest/resources/rest/optInIPPApplicant}).to_return(
      status: 200, body: UspsInPersonProofing::Mock::Fixtures.request_enroll_invalid_response,
    )
  end
  ...
  def request_in_progress_proofing_results_args
    {
      status: 400, body: UspsInPersonProofing::Mock::Fixtures.
        request_in_progress_proofing_results_response,
  ...
  def stub_request_enrollment_code
    stub_request(:post, %r{/ivs-ippaas-api/IPPRest/resources/rest/requestEnrollmentCode}).to_return(
      status: 200, body: UspsInPersonProofing::Mock::Fixtures.request_enrollment_code_response,
      headers: { 'content-type' => 'application/json' }
    )
  end
end
